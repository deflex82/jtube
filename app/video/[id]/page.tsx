...
import { EllipsisVertical, Loader2Icon, Menu } from "lucide-react"
...
const VideoPage = async ({ params }: any) => {
    ...
    const isOwner = video.clerkId === curruser?.id;
                    ...
                    <div className="flex gap-2 items-center  w-full justify-between md:justify-normal">
                        <div className="flex items-center gap-2 lg:gap-3 justify-between w-full">
                            ...
                            {isOwner ? (
                                ...
                                curruser ? (
                                    <FollowUnfollow userId={curruser.id} isFollowing={IsFollowing()} target={user.clerkId} />
                                ) : (
